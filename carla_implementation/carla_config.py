...
# correctly from Additional-Project-Final\ but WRONG from carla_implementation\.
# =============================================================================

import os

# This file lives in:  Additional-Project-Final\carla_implementation\carla_config.py
# PROJECT_ROOT is:     Additional-Project-Final\
...
SPAWN_POINT_INDEX = 16                        # Spawns exactly near the Town04 tunnel (HIGHWAY_SPAWN_INDICES: 15, 16, 17, 18)
...
# -----------------------------------------------------------------------------
# GPS DENIAL ZONES
# FIX: Coordinates here are CARLA WORLD coords, matching collect_data.py
# which uses TUNNEL_X_MIN/MAX, TUNNEL_Y_MIN/MAX (also in world coords).
# Format: (x_min, x_max, y_min, y_max) in CARLA World Frame
# -----------------------------------------------------------------------------
GPS_DENIAL_ZONES = [
